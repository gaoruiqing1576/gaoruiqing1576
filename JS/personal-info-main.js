...
$(function () {
        ...
        if (config.portfolio) {
            for (let i = 0; i < config.portfolio.length; i++) {
                ...
                e.append("<div class=\"col-md-4\">\n" +
                    ...
                    "        <a onclick=\"portfolioSectionClick("+ i +")\" href=\"javascript:void(0)\" title=\""+projectName+"\">\n" +
    ...
    //     let VideoHtml = "<button class=\"close-popup\" onclick = \"popupClose()\">"+
    //     "</button>"+
    //         "<video  class=\"video-popup\" style=\"width:100%;height:100%\" ishivideo=\"true\" autoplay=\"false\" isrotate=\"true\" autoHide=\"true\" controls=\"controls\">"+
    //         "<source src=\"./ProAssets/智慧社区.mp4\" type=\"video/mp4\">"+
    //     "</video>"
    //     $(".popup").append(VideoHtml)
...
//作品项点击后播放视频
function portfolioSectionClick(index) {
    let url = ""
    if (config) {
     url = config.portfolio[index][1]
    }
    console.log(url)
